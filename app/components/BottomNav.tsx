  ...
  const tabs = [
    {
      ...
      label: "Inicio",
      icon: (active: boolean) => (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? "#C4A86A" : "#5A6864"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
      <div
        ...
        style={{
          ...
          border: "1px solid rgba(168, 144, 96, 0.06)",
