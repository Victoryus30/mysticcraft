  ...
  const tabs = [
    {
      ...
      label: "Inicio",
      icon: (active: boolean) => (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? "#A88A3E" : "#9490A8"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50" style={{ paddingBottom: "env(safe-area-inset-bottom)" }}>
      <div
        ...
        style={{
          ...
          border: "1px solid rgba(107, 143, 199, 0.1)",
          boxShadow: "0 -4px 20px rgba(45, 42, 62, 0.06)",
        }}
      >
        {tabs.map((tab) => (
          <a
